...
Module extension for installing a diffutils toolchain.
...
| :------------- | :------------- | :------------- | :------------- | :------------- |
| <a id="diffutils.toolchain-name"></a>name |  Base name for generated repositories, allowing more than one diff toolchain to be registered. Overriding the default is only permitted in the root module.   | <a href="https://bazel.build/concepts/labels#target-names">Name</a> | optional |  `"diffutils"`  |
