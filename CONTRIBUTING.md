...
some other ruleset that depends on diff.bzl, or in a nested
...
```sh
OVERRIDE="--override_repository=diff.bzl=$(pwd)/diff.bzl"
echo "common $OVERRIDE" >> ~/.bazelrc
```

This means that any usage of `@diff.bzl` on your system will point to this folder.
...
https://github.com/kormide/diff.bzl/actions/workflows/tag.yaml
